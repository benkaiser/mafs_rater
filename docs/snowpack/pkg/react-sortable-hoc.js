...
function sortableContainer(WrappedComponent) {
  ...
  }(react.Component), _defineProperty(_class, "displayName", provideDisplayName('sortableList', WrappedComponent)), _defineProperty(_class, "defaultProps", defaultProps), _defineProperty(_class, "propTypes", propTypes$1), _defineProperty(_class, "childContextTypes", {
...
function sortableElement(WrappedComponent) {
  ...
  return _temp = _class = function (_React$Component) {
    ...
    manager: propTypes.object.isRequired
  }), _defineProperty(_class, "propTypes", propTypes$1$1), _defineProperty(_class, "defaultProps", {
    collection: 0
  }), _temp;
}

export { sortableContainer as SortableContainer, sortableElement as SortableElement, arrayMove };
